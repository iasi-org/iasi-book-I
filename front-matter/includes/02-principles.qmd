...
### 1. No somos mecanógrafos. Somos ingenieros {.unlisted}
...
### 2. El modelo no es el sistema {.unlisted}
...
### 3. Capacidad no equivale a autoridad {.unlisted}
...
### 4. Generar no es verificar {.unlisted}
...
### 5. La responsabilidad no se delega {.unlisted}
...
### 6. No automatizamos lo que no comprendemos {.unlisted}
...
### 7. El fallo forma parte del diseño {.unlisted}
...
### 8. Todo sistema debe ser controlable {.unlisted}
...
### 9. Todo debe ser trazable {.unlisted}
...
### 10. Pensar sigue siendo nuestra responsabilidad {.unlisted}
